...
urlpatterns = [
     ...
     path('editar-lista/<int:lista_id>/', views.editar_lista_view,name='editar_lista'),
     path('confirma-excluir-lista/<pk>/', views.DeletarLista.as_view(), name='confirma_excluir_lista'),
